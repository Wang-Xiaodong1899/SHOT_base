...
if __name__ == "__main__":
    ...
    parser.add_argument('--dset', type=str, default='office-home', choices=['visda', 'office', 'office-home', 'office-caltech'])
    ...
    for i in range(len(names)):
        ...
        args.savename = 'par_' + str(args.cls_par)+'_seed_'+str(args.seed)
